/*
-Cola Circular en un lenguaje que permita insertar e eliminar elementos. 
Considerar casos como vacia, llena, desboradamientos, subdesbordamiento.
por cada operaciones indicar valores de frente, finale y los mensajes correspondientes.
 */
...
import java.util.Scanner;
 ...
 public class ColaCircular<E> {
    ...
    public static void main(String[] args) {
        ...
        ColaCircular cocir = new ColaCircular();
        int dato, opc;
